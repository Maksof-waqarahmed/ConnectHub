    ...
    return (
        <form className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <div className="grid gap-6">
                ...
                <div className="grid gap-2">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/auth/forgot-password" className="text-sm text-primary hover:text-primary/90 transition-colors">
                            Forgot password?
                        </Link>
                    </div>
            ...
            <div className="text-center text-sm">
                ...
                <Link href="/auth/register" className="text-primary hover:text-primary/90 transition-colors font-medium">
                    Sign up
                </Link>
            </div>
        </form>
